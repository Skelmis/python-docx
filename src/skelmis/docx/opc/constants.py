...
class CONTENT_TYPE:
    ...
    PML_COMMENT_AUTHORS = (
        "application/vnd.openxmlformats-officedocument.presentationml.commen" "tAuthors+xml"
    )
    PML_HANDOUT_MASTER = (
        "application/vnd.openxmlformats-officedocument.presentationml.handou" "tMaster+xml"
    )
    PML_NOTES_MASTER = (
    ...
    PML_PRESENTATION_MAIN = (
        "application/vnd.openxmlformats-officedocument.presentationml.presen" "tation.main+xml"
    )
    PML_PRES_PROPS = "application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"
    PML_PRINTER_SETTINGS = (
        "application/vnd.openxmlformats-officedocument.presentationml.printe" "rSettings"
    )
    PML_SLIDE = "application/vnd.openxmlformats-officedocument.presentationml.slide+xml"
    PML_SLIDESHOW_MAIN = (
        "application/vnd.openxmlformats-officedocument.presentationml.slides" "how.main+xml"
    )
    PML_SLIDE_LAYOUT = (
    ...
    PML_SLIDE_UPDATE_INFO = (
        "application/vnd.openxmlformats-officedocument.presentationml.slideU" "pdateInfo+xml"
    )
    PML_TABLE_STYLES = (
        "application/vnd.openxmlformats-officedocument.presentationml.tableS" "tyles+xml"
    )
    PML_TAGS = "application/vnd.openxmlformats-officedocument.presentationml.tags+xml"
    PML_TEMPLATE_MAIN = (
        "application/vnd.openxmlformats-officedocument.presentationml.templa" "te.main+xml"
    )
    ...
    SML_EXTERNAL_LINK = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.externa" "lLink+xml"
    )
    SML_PIVOT_CACHE_DEFINITION = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCa" "cheDefinition+xml"
    )
    SML_PIVOT_CACHE_RECORDS = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCa" "cheRecords+xml"
    )
    ...
    SML_REVISION_HEADERS = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.revisio" "nHeaders+xml"
    )
    SML_REVISION_LOG = "application/vnd.openxmlformats-officedocument.spreadsheetml.revisionLog+xml"
    SML_SHARED_STRINGS = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sharedS" "trings+xml"
    )
    ...
    SML_SHEET_METADATA = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheetMe" "tadata+xml"
    )
    ...
    SML_TABLE_SINGLE_CELLS = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.tableSi" "ngleCells+xml"
    )
    SML_TEMPLATE_MAIN = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.templat" "e.main+xml"
    )
    SML_USER_NAMES = "application/vnd.openxmlformats-officedocument.spreadsheetml.userNames+xml"
    SML_VOLATILE_DEPENDENCIES = (
        "application/vnd.openxmlformats-officedocument.spreadsheetml.volatil" "eDependencies+xml"
    )
    ...
    WML_DOCUMENT_GLOSSARY = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.docu" "ment.glossary+xml"
    )
    WML_DOCUMENT_MAIN = (
    ...
    WML_FONT_TABLE = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.font" "Table+xml"
    )
    WML_FOOTER = "application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml"
    WML_FOOTNOTES = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.foot" "notes+xml"
    )
    WML_HEADER = "application/vnd.openxmlformats-officedocument.wordprocessingml.header+xml"
    WML_NUMBERING = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.numb" "ering+xml"
    )
    WML_PRINTER_SETTINGS = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.prin" "terSettings"
    )
    ...
    WML_WEB_SETTINGS = (
        "application/vnd.openxmlformats-officedocument.wordprocessingml.webS" "ettings+xml"
    )
    XML = "application/xml"
    X_EMF = "image/x-emf"
...
class RELATIONSHIP_TYPE:
    ...
    CORE_PROPERTIES = (
        "http://schemas.openxmlformats.org/package/2006/relationships/metada" "ta/core-properties"
    )
    CUSTOM_PROPERTIES = (
    ...
    ORIGIN = (
        "http://schemas.openxmlformats.org/package/2006/relationships/digita" "l-signature/origin"
    )
    ...
    THUMBNAIL = "http://schemas.openxmlformats.org/package/2006/relationships/metada" "ta/thumbnail"
