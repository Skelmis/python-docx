...
from skelmis.docx.oxml.exceptions import InvalidXmlError
from skelmis.docx.oxml.ns import NamespacePrefixedTag, nsmap, qn
from skelmis.docx.shared import lazyproperty

if TYPE_CHECKING:
    from skelmis.docx.enum.base import BaseXmlEnum
    from skelmis.docx.oxml.simpletypes import BaseSimpleType
