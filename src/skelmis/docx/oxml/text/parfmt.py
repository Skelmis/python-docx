...
from skelmis.docx.enum.text import (
    WD_ALIGN_PARAGRAPH,
    WD_LINE_SPACING,
    WD_TAB_ALIGNMENT,
    WD_TAB_LEADER,
)
from skelmis.docx.oxml.simpletypes import ST_SignedTwipsMeasure, ST_TwipsMeasure
...
if TYPE_CHECKING:
    ...
    from skelmis.docx.oxml.shared import CT_String
