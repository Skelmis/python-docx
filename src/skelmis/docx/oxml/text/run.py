...
from skelmis.docx.oxml.simpletypes import ST_BrClear, ST_BrType
from skelmis.docx.oxml.text.font import CT_RPr
from skelmis.docx.oxml.xmlchemy import BaseOxmlElement, OptionalAttribute, ZeroOrMore, ZeroOrOne
from skelmis.docx.shared import TextAccumulator
...
if TYPE_CHECKING:
    ...
    from skelmis.docx.oxml.text.parfmt import CT_TabStop
